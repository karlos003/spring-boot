...
<body>
	...
	<a href="<%=basePath%>index" style="color: white;font-size: 20px;font-style: italic;float:right;margin-right: 80px;margin-top: 50px;">返回首页</a><br/>
	...
	<div class="container w3layouts agileits">
		...
		<div class="login w3layouts agileits">
			...
			<form action="userController/loginControl" onsubmit="return valid()">
				<input type="text" name="user_account" placeholder="用户名" required="required" value="${cookie.account.value}">
