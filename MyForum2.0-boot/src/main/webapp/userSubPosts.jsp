		...
		<div class="content_2">
			...
			<div style="text-align: center;">
				...
				<c:if test="${sessionScope.currentPage > 1 }">
					<a href="<%=basePath%>userController/showSubsPost/${requestScope.user_account }/1">首页</a>--
					<a href="<%=basePath%>userController/showSubsPost/${requestScope.user_account }/${sessionScope.currentPage-1 }">上一页</a>--
				</c:if>
				
				<a href="<%=basePath%>userController/showSubsPost/${requestScope.user_account }/${sessionScope.currentPage+1 }">下一页</a>
